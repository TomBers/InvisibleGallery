...
//  NSArray * textureFilenames = [[NSArray alloc] initWithObjects:@"icon_play.png",@"icon_loading.png",@"icon_error.png",@"VuforiaSizzleReel_1.png",@"VuforiaSizzleReel_2.png",nil];
